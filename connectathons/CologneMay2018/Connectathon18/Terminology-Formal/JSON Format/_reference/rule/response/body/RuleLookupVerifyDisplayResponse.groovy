...
// 1st check for returned display equal to long name
...
else if (compareValue.equals(compareLongName)) {
...
if (hasVerifiedDisplayValue == false) {
	// 2nd check for returned display equal to short name
	if (compareValue.equals(compareShortName)) {
